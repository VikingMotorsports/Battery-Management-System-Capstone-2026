...
\begin{itemize}
	...
	\item Communicate with the \gls{ecu} over the \gls{can} bus.
...
These requirements were mostly set in stone at the begaining of the project. We expected to only fufill all the musts and only the should requirement tfor modular architecture.